...
function CreateCampaignModal({ open, onOpenChange }: { open: boolean; onOpenChange: (v: boolean) => void }) {
  ...
  const mutation = useMutation({
    mutationFn: async () => {
      ...
      // All payment cycles are pre-generated by the database trigger on campaigns.
      return newCamp;
    },
    onSuccess: () => {
      toast({ title: t("Campagna creata"), description: t("Cicli di pagamento generati automaticamente.") });
