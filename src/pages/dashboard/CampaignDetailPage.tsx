        ...
        <CardContent>
          {kpiLoading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              ...
              <StatItem label="Views contate" value={formatViews(kpi.data?.monthViews ?? 0)} sub={videoViewsCap != null ? `cap ${formatViews(videoViewsCap)}/video` : "senza cap"} badge={videoViewsCap != null} />
