...
import { OnboardingTemplateCard } from "@/components/companies/OnboardingTemplateCard";
...
const ROLE_COLORS: Record<string, string> = {
  ...
  operator: "bg-cyan-600/20 text-cyan-400 border-cyan-600/30",
};
...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-8 p-6">
      ...
      {/* SECTION 3b — MODELLO ONBOARDING CLIENTI */}
            ...
            <div className="space-y-2">
              ...
              <Select value={newUser.role} onValueChange={(v) => setNewUser({ ...newUser, role: v, creator_id: "", campaign_id: "" })}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="operator">Operator (Account Manager)</SelectItem>
                </SelectContent>
              </Select>
            </div>
