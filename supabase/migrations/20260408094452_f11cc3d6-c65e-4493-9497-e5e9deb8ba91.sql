...
DECLARE
  ...
  v_result json;
BEGIN
  -- Identity check: caller must be the requested user
...
BEGIN
  ...
  SELECT jsonb_build_object(
    'campaign', jsonb_build_object(
      ...
      'planned_creators', v_camp.planned_creators, 'client_cpm', v_camp.client_cpm,
      'client_fixed_per_creator', v_camp.client_fixed_per_creator, 'video_views_cap', v_camp.video_views_cap
    ),
    'accounts', v_accounts,
