...
- I loghi di lead e clienti sono caricabili dal form azienda nel bucket privato `company-logos`; lettura per utenti autenticati, scrittura riservata ad admin/team. `companies.logo_url` salva il riferimento `company-logos/<path>`.
